...
uniform vec3 u_VectorToLight;//eye space

uniform vec4 u_PointLightPositions[3];//eye space
...
vec3 getDirectionLighting();
vec3 getPointLighting();

void main() {
    materialColor = mix(vec3(0.180,0.467,0.153),vec3(0.660,0.670,0.68),a_Position.y);
